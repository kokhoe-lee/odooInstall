...
ADMIN_EMAIL="admin@upnstore.com"
##
...
EOF
  ...
  echo "Done! The Nginx server is up and running. Configuration can be found at /etc/nginx/sites-available/"
else
...
echo "CUSTOM folder: $OE_USER/custom/addons"
